...
crossorigin = "anonymous" >
    ...
    < script src = "https://cdn.rawgit.com/Thinktiv/capture-kickdrum/master/dist/bundle.js" > < /script>  < script >
    ...
    $(document).ready(function() {
        ...
        function myCallback() {
            //check when html exists and then load content
            if (!!$('html').length) {
                loadHTML();
